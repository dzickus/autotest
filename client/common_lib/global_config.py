...
shadow_config = 'shadow_config.ini'
...
global_config_path_system_wide = os.path.join(system_wide_dir, global_config)
shadow_config_path_system_wide = os.path.join(system_wide_dir, shadow_config)
...
global_config_path_root = os.path.join(root_dir, global_config)
shadow_config_path_root = os.path.join(root_dir, shadow_config)

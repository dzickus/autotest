...
try:
    ...
    import common
from autotest_lib.server import autotest_bin, utils, hosts, server_job, profilers
...
class TestBaseAutotest(unittest.TestCase):
    def setUp(self):
        ...
        self.god.stub_function(autotest_bin, "open")
        self.god.stub_function(autotest_bin.global_config.global_config,
                               "get_config_value")
        self.god.stub_function(logging, "exception")
        self.god.stub_class(autotest_bin, "_Run")
        self.god.stub_class(autotest_bin, "log_collector")
    ...
    def construct(self):
        ...
        self.base_autotest = autotest_bin.BaseAutotest(self.host)
    ...
    def test_full_client_install(self):
        ...
        c = autotest_bin.global_config.global_config
    ...
    def test_run(self):
        ...
        run_obj = autotest_bin._Run.expect_new(self.host, '.', None, False, False)
        tag = None
        ...
        autotest_bin.open.expect_call("temp").and_return(cfile)
        cfile.read.expect_call().and_return(cfile_orig)
        autotest_bin.open.expect_call("temp", 'w').and_return(cfile)
    ...
    def _stub_get_client_autodir_paths(self):
        ...
        self.god.stub_with(autotest_bin.Autotest, 'get_client_autodir_paths',
    ...
    def test_get_installed_autodir(self):
        ...
        autodir = autotest_bin.Autotest.get_installed_autodir(self.host)
    ...
    def test_get_install_dir(self):
        ...
        install_dir = autotest_bin.Autotest.get_install_dir(self.host)
        self.assertEquals(install_dir, '/another/path')


    def test_client_logger_process_line_log_copy_collection_failure(self):
        collector = autotest_bin.log_collector.expect_new(self.host, '', '')
        logger = autotest_bin.client_logger(self.host, '', '')
...
class test_autotest_mixin(unittest.TestCase):
    def setUp(self):
        ...
        self.mixin = autotest_bin.AutotestHostMixin()
